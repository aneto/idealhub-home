...
<div id="comments">
    ...
    <div id="respond">
        ...
        <p class="aviso">O seu endereço de email não será publicado Campos obrigatórios são marcados *</p>
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            <fieldset>
                ...
                <textarea name="comment" id="comment" rows="" cols="" placeholder="*Digite uma mensagem"></textarea>
